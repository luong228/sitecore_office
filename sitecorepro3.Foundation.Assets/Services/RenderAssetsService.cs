using sitecorepro3.Foundation.Assets.Models;
using System;
using System.Linq;
using System.Runtime.Remoting.Contexts;
using System.Text;
using System.Web;
using sitecorepro3.Foundation.Assets.Repositories;

namespace sitecorepro3.Foundation.Assets.Services
{
    public class RenderAssetsService
    {
        ...
        private bool IsForContextSite(Asset asset)
        {
            ...
            foreach (var part in asset.Site.Split(new[] { '|' }, StringSplitOptions.RemoveEmptyEntries))
            {
                ...
                if (siteWildcard == "*")
                {
                    //Context.Site.Name.Equals(siteWildcard, StringComparison.InvariantCultureIgnoreCase)
                    return true;
                }
            }
            return false;
